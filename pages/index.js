  ...
  return (
    <div className="font-poppins min-h-screen p-4 sm:p-6 bg-white dark:bg-black">     
      ...
      <main className={`text-darkgrey overflow-x-hidden min-h-screen w-full mx-auto shadow-lg ${className}`}>
       ...
       <div class="footer"> <a href="https://twitter.com/7310DOTeth?s=20&t=KD8pTRRzL9s7wDdy2b7sHw"><svg className="ml-96 h-14" xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
